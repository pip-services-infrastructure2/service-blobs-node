# Deployment Guide <br/> Blobs Microservice

Blobs microservice can be used in different deployment scenarios.
...
var plugin = require('service-blobs-node').BlobsSenecaPlugin;
...
or by using [BlobsSenecaClient](https://github.com/pip-services/client-blobs-node/NodeClientApiV1.md/#client_seneca)